...
Session.prototype._send = function(msg) {
  console.log('Session._send ', (+new Date()));
...
Session.prototype._sendOp = function(collection, docName, data) {
  console.log('Session._sendOp ', (+new Date()));
  var msg = {
    a: 'op',
    c: collection,
    d: docName,
...
Session.prototype._reply = function(req, err, msg) {
  console.log('Session._reply ', (+new Date()));
  if (err) {
...
Session.prototype.pump = function() {
  console.log('Session.pump ', (+new Date()));
...
Session.prototype._checkRequest = function(req) {
  console.log('Session._checkRequest ', (+new Date()));
...
Session.prototype._processQueryResults = function(results, qopts) {
  console.log('_processQueryResults ', (+new Date()));
  var session = this;
  var messages = [];
...
Session.prototype._handleMessage = function(req, callback) {
  console.log('Session._handleMessage start', (+new Date()));
  ...
  console.log('Session._handleMessage end ', (+new Date()));
};

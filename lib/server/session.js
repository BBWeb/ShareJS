...
Session.prototype._send = function(msg) {
  console.log('Session._send ', msg.id, (+new Date()));
  ...
  console.log('Start stream at ', msg.id, (+ new Date()));
  this.stream.write(msg, function () {
    console.log('Stream flushed at ', msg.id, (+new Date()));
  });
};
...
Session.prototype._reply = function(req, err, msg) {
  console.log('Session._reply ', msg.id, (+new Date()));
  if (err) {
...
Session.prototype._handleMessage = function(req, callback) {
  console.log('Session.prototype._handleMessage', req.id, (+new Date()));
